...
+(SEError*) success {
    return [self errorWithCode:0 Message:@"Success: The command executed successfully."];
}

+(SEError*) noSuchDriver {
    return [self errorWithCode:6 Message:@"NoSuchDriver: A session is either terminated or not started."];
}
